...
function names(travelDestinations){
    if (travelDestinations.length <= 500){
...
let destinationNameReachableByFerry = travelDestinations.find(destination => destination.transportations.includes("ferry")).destinationName // Complete here
...
/*let destinationNamesWithin500Kms = travelDestinations.filter(withIn500())// Complete here
function withIn500(travelDestinations){
    return travelDestinations.distanceKms <= 500
}
let destinationNameReachableByFerry = travelDestinations.find(withFerry()) // Complete here
function withFerry(travelDestinations){
